...
public class DataService
{
    ...
    {
        PN ordination = (PN) db.Ordinationer.Find(id);
        ...
        {
            return "Datoen ligger uden for ordinationens gyldighedsperiode.";
        }
        ...
        return "Ordinationen blev anvendt på den angivne dato.";
    }
	...
	public double GetAnbefaletDosisPerDøgn(int patientId, int laegemiddelId)
    {
        ...
        {
            throw new ArgumentException("Patient or lægemiddel not found.");
        }

        double anbefaletDosis;
        if (patient.vaegt < 25)
        {
            anbefaletDosis = patient.vaegt * lægemiddel.enhedPrKgPrDoegnLet;
        }
        else if (patient.vaegt > 120)
        {
            anbefaletDosis = patient.vaegt * lægemiddel.enhedPrKgPrDoegnTung;
        }
        else
        {
            anbefaletDosis = patient.vaegt * lægemiddel.enhedPrKgPrDoegnNormal;
        }
