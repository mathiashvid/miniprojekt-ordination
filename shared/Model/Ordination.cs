...
public abstract class Ordination {
    ...
    {
        // Beregn antallet af hele dage mellem startdato og slutdato inklusive
        TimeSpan periode = slutDen.Date - startDen.Date;
        return periode.Days + 1; // inklusive både start- og slutdatoen
    }
