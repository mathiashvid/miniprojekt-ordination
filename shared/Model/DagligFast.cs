...
public class DagligFast : Ordination {
    ...
    {
        // Beregn døgndosis som summen af enhederne for alle tidspunkter på en dag
        double døgndosis = MorgenDosis.antal + MiddagDosis.antal + AftenDosis.antal + NatDosis.antal;
